...
export default function PagamentiError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Pagamenti section error:', error)
  }, [error])
    ...
    <div className="p-6 lg:p-8">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            Errore nella sezione Pagamenti
          </h1>
        </div>
        <p className="text-sm" style={{ color: 'var(--stone)' }}>
          Non è stato possibile caricare i pagamenti. Riprova tra qualche istante.
        </p>
